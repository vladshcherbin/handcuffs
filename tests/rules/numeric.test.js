...
describe('numeric rule', () => {
  ...
  test('should be true when value is a string with a number and white space', () => {
    expect(numeric('  3 ')).toBe(true)
  })

  test('should be false when value is a string has only white space', () => {
    expect(numeric(' ')).toBe(false)
  })
  ...
  test('should be false when value is an array with a single string element', () => {
    expect(numeric(['Jack'])).toBe(false)
  })

  test('should be false when value is an array with a single number element', () => {
